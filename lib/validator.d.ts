...
export declare type ImportValue = ParameterValue;
...
export declare function validateString(contents: string, filename: string, options?: Partial<ValidateOptions>): ErrorObject;
...
export declare function addImportValue(parameter: string, value: ImportValue): void;
...
export declare const __TESTING__: any;
